...
describe('Allegiance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AllegianceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.allegiances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to allegianceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAllegianceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAllegianceIdentifier).toHaveBeenCalledWith(entity);
