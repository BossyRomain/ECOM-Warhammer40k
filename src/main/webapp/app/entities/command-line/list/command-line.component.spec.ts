...
import { sampleWithRequiredData } from '../command-line.test-samples';
...
describe('CommandLine Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.commandLines?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to commandLineService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCommandLineIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCommandLineIdentifier).toHaveBeenCalledWith(entity);
