...
import com.warhammer.ecom.domain.Client;
...
/**
 * REST controller for managing {@link com.warhammer.ecom.domain.Client}.
 */
@RestController
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getNewsLetter() != null) {
                    existingClient.setNewsLetter(client.getNewsLetter());
                }
