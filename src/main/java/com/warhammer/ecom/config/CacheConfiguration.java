...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.warhammer.ecom.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.warhammer.ecom.repository.UserRepository.USERS_BY_EMAIL_CACHE);
