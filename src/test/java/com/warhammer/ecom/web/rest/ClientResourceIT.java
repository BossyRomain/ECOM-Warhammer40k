...
import static com.warhammer.ecom.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    private static final Boolean DEFAULT_NEWS_LETTER = false;
    private static final Boolean UPDATED_NEWS_LETTER = true;
    ...
    public static Client createEntity() {
        return new Client()
            ...
            .newsLetter(DEFAULT_NEWS_LETTER);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client()
            ...
            .newsLetter(UPDATED_NEWS_LETTER);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].newsLetter").value(hasItem(DEFAULT_NEWS_LETTER.booleanValue())));
    }
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.newsLetter").value(DEFAULT_NEWS_LETTER.booleanValue()));
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).birthDay(UPDATED_BIRTH_DAY).newsLetter(UPDATED_NEWS_LETTER);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).birthDay(UPDATED_BIRTH_DAY);
