...
import static com.warhammer.ecom.domain.ProductImageAsserts.*;
...
class ProductImageResourceIT {
    ...
    public static ProductImage createEntity() {
        return new ProductImage().url(DEFAULT_URL).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static ProductImage createUpdatedEntity() {
        return new ProductImage().url(UPDATED_URL).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingProductImage() throws Exception {
        ...
        updatedProductImage.url(UPDATED_URL).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProductImageWithPatch() throws Exception {
        ...
        partialUpdatedProductImage.url(UPDATED_URL).description(UPDATED_DESCRIPTION);
