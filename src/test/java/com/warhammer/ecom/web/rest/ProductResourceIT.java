...
import static com.warhammer.ecom.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    private static final ProductType DEFAULT_TYPE = ProductType.Decor;
    private static final ProductType UPDATED_TYPE = ProductType.Dice;
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.price(UPDATED_PRICE).description(UPDATED_DESCRIPTION).type(UPDATED_TYPE).releaseDate(UPDATED_RELEASE_DATE);
