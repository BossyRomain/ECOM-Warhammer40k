...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableRelationshipsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getImageCatalogue()).as("check imageCatalogue").isEqualTo(actual.getImageCatalogue()))
            .satisfies(e -> assertThat(e.getAllegiance()).as("check allegiance").isEqualTo(actual.getAllegiance()));
    }
}
